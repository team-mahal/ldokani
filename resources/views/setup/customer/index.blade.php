					...
					<tbody>
						...
						<tr>
							...
							<td style="display: -webkit-inline-box;">
								<button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target=".bd-update-lg" onclick="find_customer({{$data->id}})">Edit</button>
					...
					<div class="row">
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="form-group">
								...
								<input type="text" value="{{ old('name') }}" name="name" class="form-control" placeholder="Customer Name" required>
							</div>
						</div>
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="form-group">
								<label>	Customer Email </label>
								<input type="email" value="{{ old('name') }}" name="email" class="form-control" placeholder="Customer E-mail" required>
							</div>
						</div>
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="form-group">
								<label for="description">Customer Address</label>
								<textarea class="form-control"  name="address"  placeholder="Customer address" rows="1">{{ old('description') }}</textarea>
							</div>
						</div>
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="form-group">
								<label>	Customer Contact </label>
								<input type="text" value="{{ old('name') }}" name="contact" class="form-control" placeholder="Customer Contact" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="form-group">
								<label>	Customer Name </label>
								<input type="text" value="{{ old('name') }}" name="name" id="name" class="form-control" placeholder="Customer Name" required>
							</div>
						</div>
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="form-group">
								<label>	Customer Email </label>
								<input type="email" value="{{ old('name') }}" name="email" id="email" class="form-control" placeholder="Customer E-mail" required>
							</div>
						</div>
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="form-group">
								<label for="description">Customer Address</label>
								<textarea class="form-control"  name="address" id="address"  placeholder="Customer Address" rows="1">{{ old('description') }}</textarea>
							</div>
						</div>
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="form-group">
								<label>	Customer Contact </label>
								<input type="text" value="{{ old('name') }}" name="contact" id="contact" class="form-control" placeholder="Customer Contact" required>
							</div>
						</div>
					</div>
				</div>
